import { GraduationCap, Award, Cog } from "lucide-react"
      ...
      <div className="space-y-4 text-pretty leading-relaxed text-muted-foreground">
        <p className="flex gap-3">
          ...
          <span>
            ...
            multiple distinctions in key modules such as Applications Development, Business Practice, Information
            Systems, Multimedia Applications, and Project Management.
          </span>
        </p>
        ...
        <p className="flex gap-3">
          <Cog className="mt-1 h-5 w-5 shrink-0 text-primary" />
          <span>
